...
# a self signed X-509 Certificate. This edition uses -param_enc explicit.

# Example usage:  ./ssl-ec-0002.sh mykeys secp256k1

mkdir 00_$1
cd 00_$1

openssl ecparam -out 00_ecparam_$1.pem -name $2 -param_enc explicit
openssl ecparam -genkey -out 00_private_$1.pem -name $2 -param_enc explicit
